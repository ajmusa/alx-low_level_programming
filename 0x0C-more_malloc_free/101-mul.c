 ...
 * Description: If there is insufficient space, the function exits with
 * a status of 98.
 ...
 * Return: A pointer to the next non-zero element is returned.
 */
char *iterate_zeroes(char *str)
{
	while (*str && *str == '0')
 ...
 * Description: If mult contains a non-digit, the function exits with a status
 * value of 98.
 */
void get_prod(char *prod, char *mult, int digit, int zeroes)
{
 ...
 * Description: If the number of arguments is incorrect or one number contains
 * non-digits, the function exits with a status of 98.
 * Return: Always 0.
 */
